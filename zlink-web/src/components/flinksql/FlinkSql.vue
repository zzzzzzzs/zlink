<template>
  <div>
    ...
    <el-breadcrumb separator-class='el-icon-arrow-right'>
      ...
      <el-breadcrumb-item>flink-sql</el-breadcrumb-item>
      <el-breadcrumb-item>flink-sql</el-breadcrumb-item>
    </el-breadcrumb>

    <el-card>
      这只是一个 flinksql 功能的占位，后期会迅速完善
    </el-card>
...
import "codemirror/mode/sql/sql";// 语言语法
import "codemirror/addon/hint/sql-hint.js";// sql语言提示
import "codemirror/addon/selection/active-line.js";// active-line.js
...
export default {
  ...
  data() {
    return {
      sqlCode: `CREATE TABLE datagen_1 (
                           f0 INT,
                           f1 INT,
                           f2 STRING
) WITH (
