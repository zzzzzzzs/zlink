...
// 使用自定义 CustomTableEnvironmentImpl 模拟生产数据
public class CustomDatagenSqlEnvDemo {
    public static void main(String[] args) {

        TableConfig tableConfig = new TableConfig();
        CustomTableEnvironmentImpl tableEnv = CustomTableEnvironmentImpl.create(StreamExecutionEnvironment.getExecutionEnvironment(),
